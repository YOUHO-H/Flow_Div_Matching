...
def parse_train_args():
    ...
    parser.add_argument("--max_steps", type=int, default=900000)
    ...
    parser.add_argument("--limit_val_batches", type=int, default=999)
    ...
    parser.add_argument("--start_val_epoch", type=int, default=999)

    # Data
    parser.add_argument('--dataset_type', type=str, choices=['enhancer', 'toy_fixed','toy_sampled'], default='toy_sampled')
    parser.add_argument("--mel_enhancer", action='store_true')
    parser.add_argument("--overfit", action='store_true')
    parser.add_argument("--promoter_dataset", action='store_true')
    parser.add_argument("--toy_simplex_dim", type=int, default=40)
    parser.add_argument("--toy_num_cls", type=int, default=1)
    parser.add_argument("--toy_num_seq", type=int, default=1000)
    parser.add_argument("--toy_seq_len", type=int, default=4)
    ...
    # Model
    parser.add_argument("--model", choices=['8M', '35M', '150M', '650M', '3B', '15B','mlp', 'cnn', 'transformer', 'deepflybrain'], default='cnn')
    ...
    parser.add_argument("--mode", choices=['distill', 'dirichlet', 'riemannian', 'mlm', 'ardm', 'lrar', 'cdcd', 'ppl_eval'], default='riemannian')
    ...
    parser.add_argument('--prob_reg', type=float, default=0)

    # Logging
    parser.add_argument("--no_tqdm", action="store_true")
    parser.add_argument("--print_freq", type=int, default=200)
    parser.add_argument("--wandb", action="store_true", default=False)
    parser.add_argument("--run_name", type=str, default="promo_diri")
    
    args = parser.parse_args()
    args.run_name = args.run_name + '_seed' + str(args.seed)
    if args.prob_reg > 0:
        args.run_name = args.run_name + '_' + 'reg-{}'.format(args.prob_reg)
