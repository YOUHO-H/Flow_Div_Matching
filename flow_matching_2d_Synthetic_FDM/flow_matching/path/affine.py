...
class AffineProbPath(ProbPath):
    ...
    def sample(self, x_0: Tensor, x_1: Tensor, t: Tensor) -> PathSample:
        ...
        u_t = dx_t
        d_log_p_t = (alpha_t * x_1-x_t) / sigma_t**2
        d_u_t = d_sigma_t / sigma_t

        return PathSample(x_t=x_t, dx_t=dx_t, x_1=x_1, 
                          x_0=x_0, t=t, sigma_t=sigma_t, 
                          d_log_p_t=d_log_p_t, d_u_t=d_u_t,
                          u_t=u_t)
