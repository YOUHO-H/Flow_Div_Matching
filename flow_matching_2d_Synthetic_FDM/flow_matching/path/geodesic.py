...
#         inputs: Input tensor
#         vector: Vector to multiply with the Jacobian
    
#     Returns:
#         The result of the jvp computation.
#     """
#     inputs = inputs.detach().requires_grad_(True)
#     outputs = func(inputs)
#     jac = jacobian(func, inputs)
#     return torch.matmul(jac, vector)

# def vmap(func, inputs):
#     """
#     Apply `func` over batched inputs.
