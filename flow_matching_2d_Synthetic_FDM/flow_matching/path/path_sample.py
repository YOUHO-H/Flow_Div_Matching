...
class PathSample:
    ...
    sigma_t: Tensor = field(metadata={"help": "sigma_t, shape (batch_size, ...)."})
    d_log_p_t: Tensor = field(metadata={"help": "score function of x_t (batch_size, ...)."})
    d_u_t: Tensor = field(metadata={"help": "grad of u_t(x_t|x_1) (batch_size, ...)."})
    u_t: Tensor = field(metadata={"help": "u_t(x_t|x_1) (batch_size, ...)."})
